...
| <kbd>Mod</kbd> + <kbd>Left/Right</kbd>           | Move between workspaces                |
...
| <kbd>Mod</kbd> + <kbd>V</kbd>                    | Open clipboard image viewer            |
| <kbd>Mod</kbd> + <kbd>]</kbd>                    | Open Qutebrowser                       |
| <kbd>Mod</kbd> + <kbd>[</kbd>                    | Open Terminal                          |
| <kbd>Mod</kbd> + <kbd>?</kbd>                    | Show Keybindings                       |
...
| <kbd>H/J/K/L/Arrows</kbd> | Resize windows by 50px   |
| <kbd>Shift + +/-</kbd>    | Increase / Decrease gaps |
| <kbd>Esc / Enter</kbd>    | Exit mode                |
